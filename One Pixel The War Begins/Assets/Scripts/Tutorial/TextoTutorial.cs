...
public class TextoTutorial : MonoBehaviour
{
    ...
    "一像素：战争开始",
    "使用箭头键或 AWSD 键进行移动和跳跃",
    "按下 Z 键或鼠标左键进行射击",
    "按下 X 键或鼠标右键召唤平台，记住你不能在地面或其他平台上召唤平台，你也可以按 SHIFT 键删除你所在的平台",
    "按下空格键或鼠标中键可以进行冲刺，从而更快前进，在空中只能使用一次，而在地面上可无限使用",
    "这里可以看到你的生命条",
    "按下 Esc 键可暂停和继续游戏",
    "既然你已经学会了一切，现在该出发了，顺便说一句，你还有一个王国需要拯救"
};
